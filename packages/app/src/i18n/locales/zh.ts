...
export default {
  ...
  "session.new_task_flyout": "新任务",
  "session.file_modified_flyout": "文件已修改",
  "session.attach_files_token": "添加服务器令牌以附加文件。",
  "session.attach_files_connect": "连接到 OpenWork 服务器以附加文件。",

  "session.sidebar.tasks": "任务",
  ...
  "session.composer.placeholder": "询问 OpenWork...",
  ...
  "session.splash.hero_title": "今天想做些什么？",
  "session.splash.hero_description": "选择一个起点或直接在下方输入。",
  "session.splash.automate_browser": "自动化您的浏览器",

  "session.share.workspace_url": "OpenWork 工作区 URL",
  ...
  "session.scheduled.source_remote": "来自 OpenWork 服务器",
  "session.scheduled.source_local": "来自本地调度器",
  "session.scheduled.description_remote": "在连接的 OpenWork 服务器上按计划运行的自动化任务。",
  ...
  "session.scheduled.support_remote_unavailable": "OpenWork 服务器不可用。连接以同步计划任务。",
  "session.scheduled.support_desktop_required": "计划任务需要桌面应用程序。",
  "session.scheduled.support_windows_unsupported": "Windows 暂不支持调度程序。",
  "session.scheduled.delete_description_remote": "这将从连接的 OpenWork 服务器中删除计划和任务定义。",
  ...
  "config.reload.reason_remote_only": "重载仅适用于本地工作区或已连接的 OpenWork 服务器。",
  ...
  "config.sharing.title": "OpenWork 服务器分享",
  "config.sharing.description": "与受信任的设备分享这些详情。保持服务器在同一网络中以实现最快设置。",
  "config.sharing.server_url": "OpenWork 服务器 URL",
  ...
  "config.server.title": "OpenWork 服务器",
  "config.server.description": "连接到 OpenWork 服务器。使用服务器管理员提供的 URL 和访问令牌。",
  "config.server.url_label": "OpenWork 服务器 URL",
  "config.server.url_placeholder": "http://127.0.0.1:8787",
  "config.server.url_hint": "使用您的 OpenWork 服务器分享的 URL。",
  ...
  "config.server.connection_needed": "需要 OpenWork 服务器连接以同步 skills、插件和命令。",
